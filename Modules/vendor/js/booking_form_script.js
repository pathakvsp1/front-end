...
let mainmodel = `<div class="field_container">
          ...
          <div id="elementForm">
            ...
            <div>
              <input type="checkbox" name="reqField" id="reqField" value="require"> <label for="reqField">required</label> 
            </div>
...
function setInputField(inputValue, check) {
  ...
  inputfield = `<div class="field_container">
          ...
          <form action="">
            ...
            <div>
              <input type="checkbox" name="reqField" id="reqField" value="require" ${c}> <label for="reqField">required</label> 
            </div>
          </form>
          <section class="buttons">
            <button class = "exit" type="button">Cancel</button>
...
function setOptionsField(inputValue, answers, require, type) {
  ...
  optionsfield = `<div class="field_container">
          ...
          <form action="">
            ...
            <div>
              <input type="checkbox" name="reqField" id="reqField" value="require" ${req}><label for="reqField">required</label> 
            </div>
            ${radioOrCheck}
            ${options}
  ...
  if (radio || r) {
    ...
    answers.forEach((element) => {
      if (!element.value) {
        ...
        opts += `<div><input type="checkbox" name="${element.value}" id="${element.value}" value=${element.value} ${req}>
                <label for="${element.value}">${element.value}</label></div>
                `;
      }
    });
